...
const ko = {
  ...
  'sched.emptyHint': 'AI 탭에서 /조치로 페이지를 분석한 뒤 답변 아래의 "일정으로 등록"을 누르면 여기에 쌓입니다.',
  ...
  'quality.kind.summary': '페이지 요약',
  'quality.cache': '분석 결과 캐시',
  'quality.cacheValue': '{n}건 저장됨',
  'quality.cacheDesc': '같은 페이지를 다시 분석할 때 본문이 그대로면 저장해 둔 결과를 보여 줍니다. 본문이 바뀌었으면 다시 분석합니다.',
  ...
  'msg.originAutomation': '저장된 일정에서 읽음',
  ...
  'onboard.title': 'sAIde 사용법',
  'onboard.step': '{n} / {total}',
  'onboard.skip': '건너뛰기',
  'onboard.prev': '이전',
  'onboard.next': '다음',
  'onboard.done': '시작하기',
  'onboard.1.title': '보고 있는 페이지를 그대로 붙입니다',
  'onboard.1.a': '읽던 페이지에서 사이드패널을 열고 이 페이지 요약을 누르면, 본문을 읽어 대화에 붙입니다.',
  'onboard.1.b': '한 번 붙여 두면 이어지는 질문은 빠릅니다. 본문이 프롬프트 앞쪽에 그대로 남아 다시 계산하지 않기 때문입니다.',
  'onboard.2.title': '슬래시는 여기서 끝나고, 골뱅이는 다른 탭에 남습니다',
  'onboard.2.a': '입력창에 / 또는 @ 를 치면 명령 목록이 뜹니다.',
  'onboard.2.b': '/요약 /번역 /조치 는 답이 이 창에 나옵니다. @일정 은 결과가 일정 탭에 남고, 답변의 링크를 눌러야 그 탭으로 갑니다.',
  'onboard.3.title': '페이지에서 나온 기한은 일정 탭으로',
...
const en = {
  ...
  'sched.emptyHint': 'Run /actions on a page in the AI tab, then use "Add to schedule" under the answer.',
  ...
  'sched.openDoc': 'Open source page',
  'sched.viewMode': 'View',
  ...
  'quality.kind.summary': 'Page summary',
  'quality.cache': 'Analysis cache',
  'quality.cacheValue': '{n} stored',
  'quality.cacheDesc': 'When the same page is analyzed again and its body is unchanged, the stored result is shown. A changed body is always re-analyzed.',
  ...
  'msg.originAutomation': 'Read from saved tasks',
  ...
  'onboard.title': 'How sAIde works',
  'onboard.step': '{n} / {total}',
  'onboard.skip': 'Skip',
  'onboard.prev': 'Back',
  'onboard.next': 'Next',
  'onboard.done': 'Get started',
  'onboard.1.title': 'It attaches the page you are reading',
  'onboard.1.a': 'Open the side panel on any page and press Summarize this page: the text is read and attached to the conversation.',
  'onboard.1.b': 'Once attached, follow-up questions are fast — the text stays at the front of the prompt and is not recomputed.',
  ...
  'onboard.2.b': '/summary /translate /actions answer in this window. @schedule leaves results in the Schedule tab — follow the link in the answer to go there.',
  'onboard.3.title': 'Due dates found on a page go to the Schedule tab',
